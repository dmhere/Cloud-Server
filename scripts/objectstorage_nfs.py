...
def object_storage():
	...
	ssIP="192.168.43.80"   #ss=storage server
	ssp="ub"
	...
	clientServiceStatus=commands.getstatusoutput("sudo sshpass -p {0} ssh -o stricthostkeychecking=no -l root {1} mount {2}:/cloud/{3} /media/{3}drive".format(userPassword,userIP,ssIP,userName))
